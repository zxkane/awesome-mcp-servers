...
- [@executeautomation/playwright-mcp-server]([https://github.com/Automata-Labs-team/MCP-Server-Playwright](https://github.com/executeautomation/mcp-playwright)) 🌐🖱️ - An MCP server using Playwright for browser automation and webscrapping
