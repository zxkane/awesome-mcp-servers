...
- [gpt-computer-assistant](https://github.com/Upsonic/gpt-computer-assistant) Dockerized Computer Use Agents with Production Ready API’s - MCP Client for Langchain
